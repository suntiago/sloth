...
import com.suntiago.sloth.R;
import com.suntiago.sloth.utils.FileUtils;
import com.suntiago.sloth.utils.ToastUtils;
...
public class ShadowPickMediaActivity extends Activity implements TakePhoto.TakeResultListener,
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    TFileUtils.setCachePath(
        mStorageHelper.getSDCardPath() + "image/take_photo/cache/");
          ...
          public void call(Boolean granted) {
            if (!granted) {
              ToastUtils.showToast(ShadowPickMediaActivity.this,
                  getResources().getString(R.string.sloth_please_turn_on_the_permission_of_external_storage));
    ...
    RxPermissions.getInstance(this)
        ...
        .subscribe(new Action1<Boolean>() {
          ...
          public void call(Boolean granted) {
            if (!granted) {
              ToastUtils.showToast(ShadowPickMediaActivity.this,
                  getResources().getString(R.string.sloth_please_turn_on_the_permission_of_camera));
              Intent intent = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS);
              intent.setData(Uri.parse("package:" + ShadowPickMediaActivity.this.getPackageName()));
              startActivity(intent);
              finish();
  ...
  protected void setTakePhotoConfig(boolean isGallery, CropOptions cropOptions, ConfigPicturePick configPicturePick, int imageInsert) {
    File file = new File(mStorageHelper.getSDCardPath() + "image/take_photo/photo/" + System.currentTimeMillis() + ".jpg");
        ...
        .subscribe(new Action1<Boolean>() {
          ...
          public void call(Boolean granted) {
            if (!granted) {
              ...
              File file = new File(mStorageHelper.getSDCardPath() + "image/take_photo/video/"  + System.currentTimeMillis());
              if (file.exists()) {
                file.delete();
              }
