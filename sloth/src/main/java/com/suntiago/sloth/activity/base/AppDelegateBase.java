...
import com.suntiago.sloth.activity.base.theMvp.view.AppDelegate;
import com.suntiago.sloth.activity.view.ProgressDialog;
  ...
  public Toolbar getToolbar() {
    if (mToolbar == null && rootView instanceof ViewGroup) {
      mToolbar = (Toolbar) LayoutInflater.from(rootView.getContext()).inflate(
              R.layout.sloth_element_toolbar, (ViewGroup) rootView, false);
