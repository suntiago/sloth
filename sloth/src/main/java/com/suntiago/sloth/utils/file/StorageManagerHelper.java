package com.suntiago.sloth.utils.file;
...
public class StorageManagerHelper {
  ...
  /**
   * 目前 {@link com.suntiago.sloth.utils.log.Slog},
   * {@link com.suntiago.sloth.utils.log.CrashHandler},
   * {@link com.suntiago.sloth.activity.base.pickmedia.ShadowPickMediaActivity}
   * 用到了存储，需要修改。
   */
