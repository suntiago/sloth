...
import com.suntiago.sloth.activity.base.pickmedia.IMediaPicker;
import com.suntiago.sloth.activity.base.pickmedia.ImagePic;
import com.suntiago.sloth.activity.base.pickmedia.MediaPickerDelegate;
...
public class MainActivity extends Activity {
  ...
  public void onclickTestMvp(View view) {
    startActivity(new Intent(this, ActivityMvpTest.class));
  }
  ...
  public void onclickTakeVideo(View view) {
    MediaPickerDelegate.get().configPickVideo(1, 5).takeVideo(this,
        new IMediaPicker.PMVCallback() {
          @Override
          public void pickMV(String videoPath) {
  ...
  public void onclickTakePhoto(View view) {
    MediaPickerDelegate.get().pickPicture(this, false,
        new IMediaPicker.PP1Callback() {
          @Override
